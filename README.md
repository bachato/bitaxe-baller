...
<p align="center">
  <img src="./screenshots/home.png" alt="Bitaxe Baller home view — compact card per device with health border colors" width="900">
</p>
...
<p align="center">
  <img src="./screenshots/home.png" alt="Home view: compact card per Bitaxe with severity-colored borders" width="900">
  <br><em>Home — one card per device, scales from 3 miners to 30. Health borders flag attention.</em>
</p>

<p align="center">
  <img src="./screenshots/detail.png" alt="Device detail view with charts, tuning controls, and pool config" width="900">
  <br><em>Detail — full metrics, hashrate + temps charts, tuning, fan, pool config, recommendations, event log.</em>
</p>

<p align="center">
  <img src="./screenshots/scan.png" alt="Network scanner mid-run, cycling through IPs" width="900">
